...
class Objeto {
    ...
    public function getIdUbicacion() { return $this->id_ubicacion; }
    public function setIdUbicacion($id_ubicacion) { $this->id_ubicacion = $id_ubicacion; }

    public function getIdEstadoObjeto() { return $this->id_estado_objeto; }
    public function setIdEstadoObjeto($id_estado_objeto) { $this->id_estado_objeto = $id_estado_objeto; }
    ...
    public function getFechaEncontrado() { return $this->fecha_encontrado; }
    public function setFechaEncontrado($fecha_encontrado) { $this->fecha_encontrado = $fecha_encontrado; }
